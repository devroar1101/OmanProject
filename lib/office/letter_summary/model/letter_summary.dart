class LetterSummaryResult {
  ...
  // Method to conditionally set the names based on language
  void _setNames(String lang) {
    cabinetName = lang == 'ar' ? cabinetNameArabic : cabinetNameEnglish;
    folderName = lang == 'ar' ? folderNameArabic : folderNameEnglish;
    dgName = lang == 'ar' ? dgNameArabic : dgNameEnglish;
    departmentName =
        lang == 'ar' ? departmentNameArabic : departmentNameEnglish;
    sectionName = lang == 'ar' ? sectionNameArabic : sectionNameEnglish;
    locationName = lang == 'ar' ? locationNameArabic : locationNameEnglish;
  }
